...
- **Kalshi**: [Trade API v2](https://trading-api.readme.io/reference/getmarkets) — public REST API, no auth required for market data. Note: REST APIs cannot be opened in a browser — the app calls specific endpoints (e.g. `/events`, `/markets`) programmatically. Navigating to the base URL directly will return a 404.
